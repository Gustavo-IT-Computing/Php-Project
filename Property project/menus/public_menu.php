...
$userPermissions = getUserRolePermissions('public');
...
<head>
    ...
    <!--giving the title for the public page -->
    <title>Public Menu</title>
...
<body>
    <header>
        ...
        <h1>HYNESDRADE</h1>
            <ul>
                <li class="<?php echo ($currentPage == 'Home') ? 'nav-active' : ''; ?>"><a href="index.php">Home</a></li>
                <li class="<?php echo ($currentPage == 'Search') ? 'nav-active' : ''; ?>"><a href="search.php">Search</a></li>
                <li class="<?php echo ($currentPage == 'Adverts') ? 'nav-active' : ''; ?>"><a href="adverts.php">Adverts</a></li>
                <li class="<?php echo ($currentPage == 'Testimonial') ? 'nav-active' : ''; ?>"><a href="testimonial.php">Testimonial</a></li>
                <li class="<?php echo ($currentPage == 'Contact Us') ? 'nav-active' : ''; ?>"><a href="contact_us.php">Contact Us</a></li>
            </ul>
...
<div class="dropdown">
    <?php if ($userEmail) : ?>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
            <button type="submit" name="logout" class="dropbtn">Public Logout (<?php echo $userEmail; ?>)</button>
        </form>
    <?php else : ?>
