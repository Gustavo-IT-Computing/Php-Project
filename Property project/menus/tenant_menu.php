...
// Get user role permissions for 'admin' role from roles.php
$userPermissions = getUserRolePermissions('tenant');
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <!--giving the title for the tenant page -->
        ...
        <nav>
            ...
            <ul>
                ...
                <li class="<?php echo ($currentPage == 'Adverts') ? 'nav-active' : ''; ?>"><a href="../pages/adverts.php">Adverts</a></li>
                 <li class="<?php echo ($currentPage == 'Inventory Details') ? 'nav-active' : ''; ?>"><a href="../pages/inventory_details.php">Inventory</a></li>
                
                <!-- Testimonials Dropdown -->
                <li class="dropdown <?php echo ($currentPage == 'Testimonial' || $currentPage == 'Add Testimonial') ? 'nav-active' : ''; ?>">
                    <a>Testimonials</a>
                ...
                <!-- Account Dropdown -->
                <li class="dropdown <?php echo ($currentPage == 'Tenancy Account' || $currentPage == 'Password Reset') ? 'nav-active' : ''; ?>">
                    <a>Account</a>
                    <div class="dropdown-content">
            ...
            <div class="dropdown">
                <?php if ($userEmail) : ?>
                    ...
                    <button type="submit" name="logout" class="dropbtn">Tenant Logout (<?php echo $userEmail; ?>)</button>
                    </form>
                <?php else : ?>
