...
require_once '../functionality/roles.php'; // requiring the roles.php inside the functionality folder
...
// Get user role permissions for 'public' role from roles.php
$userPermissions = getUserRolePermissions('admin');

// List of pages accessible to the public
...
<head>
    ...
    <!--giving the title for the Admin page -->
...
<body>
    <header>
        <nav>
            <h1>HYNESDRADE</h1>
            <ul>
                <li class="dropdown <?php echo ($currentPage == 'Home' || $currentPage == 'Edit Home') ? 'nav-active' : ''; ?>">
                    <a>Home</a>
                    <div class="dropdown-content">
                        <a href="../pages/index.php">Home </a>
                        <a href="../pages/index_edit.php">Edit Home</a>
                    </div>
                </li>
                ...
                <li class="dropdown <?php echo ($currentPage == 'Tenancy Account' || $currentPage == 'Edit Tenancy') ? 'nav-active' : ''; ?>">
                    <a>Tenancy</a>
                    <div class="dropdown-content">
                        <a href="../pages/tenancy_account.php">Tenancy Account</a>
                        <a href="../pages/tenants_account_edit.php">Edit Tenancy</a>
                    </div>
                </li>

                 <!-- Account Dropdown -->
                <li class="dropdown <?php echo ($currentPage == 'Landlord Account' || $currentPage == 'Landlord Settings' || $currentPage == 'Edit Landlord'  ) ? 'nav-active' : ''; ?>">
                    <a>Landlord</a>
                    <div class="dropdown-content">
                        <a href="../pages/landlords_account.php">Landlord Account</a>
                        <a href="../pages/landlord_settings.php">Landlord Settings</a>
                        <a href="../pages/landlords_account_edit.php">Edit Landlord</a>
                        
                    </div>
                </li>
                
                <!-- Testimonials Dropdown -->
                <li class="dropdown <?php echo ($currentPage == 'Testimonial' || $currentPage == 'Testimonial Add' || $currentPage == 'Manage Testimonial') ? 'nav-active' : ''; ?>">
                    <a>Testimonials</a>
                    <div class="dropdown-content">
                        <a href="../pages/testimonial.php">Testimonials</a>
                        <a href="../pages/testimonial_add.php">Add Testimonial</a>
                        <a href="../pages/testimonial_manage.php">Manage</a>
                    </div>
                </li>

                <li class="dropdown <?php echo ($currentPage == 'Contact Us' || $currentPage == 'Manage Contact') ? 'nav-active' : ''; ?>">
                    <a>Contact</a>
                    <div class="dropdown-content">
                        <a href="../pages/contact_us.php">Contact Us</a>
                        <a href="../pages/contact_us_manage.php">Manage</a>
                    </div>
                </li>
                <li class="<?php echo ($currentPage == 'Password Reset') ? 'nav-active' : ''; ?>"><a href="password_reset.php">Password</a></li>
            </ul>

            <div class="dropdown">
                    <!-- Display user email and logout button if logged in -->
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
                    <button type="submit" name="logout" class="dropbtn">Admin Logout (<?php echo $userEmail; ?>) </button>
                    </form>
            </div>
        </nav>
    </header>
